...
export const WORLDGEN_PRESETS = {
    default: {
        name: 'Default',
        terrain: {
            scale: 110,        // 噪声缩放比例 - 越小，地形起伏越频繁/陡峭
            magnitude: 18,     // 地形高度幅度 - 控制山脉的最大高度变化
            offset: 10,        // 基准高度偏移 - 整体地形的基础海拔
            fbm: {
                octaves: 6,      // 分形叠加层数 - 越多细节越丰富
                gain: 0.55,      // 每层振幅衰减系数 - 越大次级细节越明显
                lacunarity: 2.2, // 每层频率倍增系数 - 越大细节频率越高
            },
        },
        // trees - 树木生成参数（高度、半径、密度）
        trees: {
            minHeight: 3,
            maxHeight: 6,
            minRadius: 2,
