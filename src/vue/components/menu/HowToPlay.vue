...
const nextLabel = computed(() => (currentIndex.value === pages.length - 1 ? t('howto.done') : t('howto.next')))
  ...
  <div class="howto">
    ...
    <main class="mc-panel howto__panel">
      ...
      <ul class="howto__body">
        <li v-for="i in currentPage.bodyCount" :key="i" class="howto__bodyLine mc-text">
      ...
      <div v-if="currentPage.keybindCount" class="howto__keybinds">
        ...
        <div class="howto__keybindGrid">
          <div v-for="i in currentPage.keybindCount" :key="i" class="howto__keybindRow">
...
.illus--comic {
  ...
  gap: 6px;
  padding: 6px;
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.06), rgba(0, 0, 0, 0.01));
}
...
.comicCell--quadrant:nth-child(1) {
  background-position: 0 0;
}

.comicCell--quadrant:nth-child(2) {
  background-position: 100% 0;
}

.comicCell--quadrant:nth-child(3) {
  background-position: 0 100%;
}

.comicCell--quadrant:nth-child(4) {
